package br.com.jonatha.projeto;
...
public class ProjetojonathaApplication implements CommandLineRunner{
	...
	public static void main(String[] args) {
		SpringApplication.run(ProjetojonathaApplication.class, args);
	}
