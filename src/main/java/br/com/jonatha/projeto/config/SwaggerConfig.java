...
public class SwaggerConfig implements WebMvcConfigurer {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("br.com.jonatha.projeto.resources"))
				.paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API do projeto de integração Java+Spring+Ionic",
				"Esta API é utilizada na integração de JAVA com Ionic", "Versão 1.0", null,
				new Contact("Jonatha Quueiroz", "https://github.com/jonathac", "jonathacassio@gmail.com"),
				"Permitido uso testes", null, Collections.emptyList() // Vendor
																		// Extensions
		);
	}
