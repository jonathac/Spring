...
import br.com.jonatha.projeto.repositories.CidadeRepository;
...
import br.com.jonatha.projeto.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "jonathacassio@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,pe.encode("123"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "email@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
